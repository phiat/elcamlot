defmodule Carscope.Alpaca do
  ...
  defp api_key, do: Application.get_env(:carscope, :alpaca_api_key, System.get_env("APCA_API_KEY_ID", ""))
  defp api_secret, do: Application.get_env(:carscope, :alpaca_api_secret, System.get_env("APCA_API_SECRET_KEY", ""))
end
