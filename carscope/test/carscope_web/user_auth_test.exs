defmodule CarscopeWeb.UserAuthTest do
  use CarscopeWeb.ConnCase, async: true

  alias Carscope.Accounts
  alias Carscope.Accounts.Scope
  alias CarscopeWeb.UserAuth

  import Carscope.AccountsFixtures

  @remember_me_cookie "_carscope_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CarscopeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
