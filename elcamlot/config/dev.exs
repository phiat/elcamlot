...
config :elcamlot, ElcamlotWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/elcamlot_web/router\.ex$"E,
      ~r"lib/elcamlot_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Swoosh local adapter for dev
config :elcamlot, Elcamlot.Mailer, adapter: Swoosh.Adapters.Local

# Enable dev routes for dashboard and mailbox
config :elcamlot, dev_routes: true
