defmodule Elcamlot.BraveSearch.Throttler do
  @moduledoc """
  ...
  @monthly_limit Application.compile_env(:elcamlot, :brave_monthly_limit, 2000)
  @search_rate_limit Application.compile_env(:elcamlot, :brave_rate_limit, 10)
  @search_window_ms Application.compile_env(:elcamlot, :brave_rate_window_ms, 60_000)
