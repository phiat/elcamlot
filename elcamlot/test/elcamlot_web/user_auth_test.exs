defmodule ElcamlotWeb.UserAuthTest do
  use ElcamlotWeb.ConnCase, async: true

  alias Elcamlot.Accounts
  alias Elcamlot.Accounts.Scope
  alias ElcamlotWeb.UserAuth

  import Elcamlot.AccountsFixtures

  @remember_me_cookie "_elcamlot_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ElcamlotWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
